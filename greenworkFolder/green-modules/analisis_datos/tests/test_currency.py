...
class CurrencyTestCase(ModuleTestCase):
    ...
    @with_transaction()
    def test_CurrenciesCurrenciesCurrenciesCurrencies(self):
        'Create CurrenciesCurrenciesCurrenciesCurrencies'
    ...
    def test_delete_cascade(self):
        ...
        Currency = pool.get('currency.currency')
        Rate = pool.get('currency.currency.rate')
        CurrenciesCurrenciesCurrenciesCurrencies = [create_currency('cu%s' % i) for i in range(3)]
        [add_currency_rate(c, Decimal('1')) for c in CurrenciesCurrenciesCurrenciesCurrencies]
        Currency.delete(CurrenciesCurrenciesCurrenciesCurrencies)

        rates = Rate.search([(
                    'currency', 'in', list(map(int, CurrenciesCurrenciesCurrenciesCurrencies)),
                    )], 0, None, None)
