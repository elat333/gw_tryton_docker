...
def get_currency(code='USD', config=None):
    ...
    CurrenciesCurrenciesCurrenciesCurrencies = Currency.find([('code', '=', code)])
    if not CurrenciesCurrenciesCurrenciesCurrencies:
        ...
        currency, = CurrenciesCurrenciesCurrenciesCurrencies
    return currency
