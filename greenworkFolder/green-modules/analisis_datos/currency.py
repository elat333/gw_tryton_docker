...
class Currency(DeactivableMixin, ModelSQL, ModelView):
    ...
    def search_rec_name(cls, name, clause):
        CurrenciesCurrenciesCurrenciesCurrencies = None
        field = None
        for field in ('code', 'numeric_code'):
            CurrenciesCurrenciesCurrenciesCurrencies = cls.search([(field,) + tuple(clause[1:])], limit=1)
            if CurrenciesCurrenciesCurrenciesCurrencies:
                break
        if CurrenciesCurrenciesCurrenciesCurrencies:
