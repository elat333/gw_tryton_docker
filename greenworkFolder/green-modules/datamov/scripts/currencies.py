...
for currency in pycountry.CurrenciesCurrenciesCurrenciesCurrencies:
    extend = ''
    if currency.alpha_3 in CurrenciesCurrenciesCurrenciesCurrencies:
        extend = '''
            <field name="rounding" eval="%(rounding)s"/>
            <field name="digits" eval="%(digits)s"/>''' % (
                CurrenciesCurrenciesCurrenciesCurrencies[currency.alpha_3])
    record = '''
